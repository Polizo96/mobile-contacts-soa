...
public class MobileContactServiceImpl implements IMobileContactService{
    ...
    @Override
    public MobileContact updateMobileContact(long id, MobileContactDTO contactDTO) throws MobileContactNotFoundException, PhoneNumberAlreadyExistsException, UserIdAlreadyExistsException {
        MobileContact mobileContact = null;
        try {
            mobileContact = new MobileContact();
            mapMobileContact(mobileContact, contactDTO);
